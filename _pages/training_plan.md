...
| **Thursday** | 🏋️ **Gym – Lower Body & Functional Strength** | 40–50 min | Moderate | Squats, lunges, deadlifts, core. Improves leg power & endurance. |
| **Friday** | 🏃 **Zone 2 Endurance Run** | 45–60 min | Low–Moderate | Steady pace where you can talk easily. Builds aerobic base. |
| **Saturday** | 🏃‍♂️ **Optional Intervals / Tempo Run** | 40–50 min | High | Only if recovered: 4×4 min hard, 3 min easy between. Boosts VO₂ max further. |
| **Sunday** | 😌 **Rest or Light Activity** | — | Low | Walk, stretch, or total rest. Prioritize recovery. |
